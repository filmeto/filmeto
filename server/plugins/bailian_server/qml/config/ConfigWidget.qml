        ...
        TabBar {
            ...
            TabButton {
                ...
                background: Rectangle {
                    ...
                    // Bottom border fix for selected tab
                    Rectangle {
        ...
        StackLayout {
            ...
            ScrollView {
                ...
                Flickable {
                    ...
                    contentHeight: basicConfigLayout.implicitHeight + 32

                    ColumnLayout {
                        id: basicConfigLayout
