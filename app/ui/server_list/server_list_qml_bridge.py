"""QObject bridge and translated labels for server list QML."""
...
class ServerListLabels(QObject):
    ...
    def set_static_labels(self, *, empty_text: str, no_description: str, plugin_prefix: str,
                          enable: str, disable: str, edit: str, delete_text: str) -> None:
