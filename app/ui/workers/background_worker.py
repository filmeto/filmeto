"""QObject facade for one-shot callables on the shared TaskManager pool.

Runs work via :class:`app.ui.core.base_worker.FunctionWorker` and
:class:`app.ui.core.task_manager.TaskManager`; lifecycle is mirrored on
:class:`app.ui.core.event_bus.EventBus`.
"""
