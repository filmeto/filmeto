...
class Text2Music(BaseTool, BaseTaskWidget):

    def __init__(self, workspace, editor=None):
        super().__init__(workspace)
        self.setObjectName("tool_text_to_music")
    ...
    async def execute(self, task):
        ...
        try:
            ...
            logger.error(f"Error in Text2Music.execute: {e}", exc_info=True)
