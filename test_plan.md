...
| `tests/unit/test_agent/test_agent_core.py` | `agent/core/filmeto_constants.py`, `agent/core/filmeto_instance.py`, `agent/core/filmeto_utils.py` |
| `tests/unit/test_agent/test_agent_events.py` | `agent/event/agent_event.py`, `agent/event/__init__.py` |
| `tests/unit/test_agent/test_agent_react_full.py` | `agent/react/status.py`, `agent/react/todo.py`, `agent/react/types.py`, `agent/react/__init__.py` |
| `tests/unit/test_agent/test_agent_crew_management.py` | `agent/crew/crew_member.py`, `agent/crew/crew_service.py`, `agent/crew/crew_title.py`, `agent/crew/__init__.py` |
| `tests/unit/test_agent/test_agent_filmeto_agent.py` | `agent/filmeto_agent.py` |
